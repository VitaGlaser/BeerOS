...
namespace AsnPlus
{
    ...
    public:
        ...
        Cloud::ConnectionConfig connectionConfig {};
        ...
        EventMonitor::Event * eventHistory0Buffer = static_cast< EventMonitor::Event * >(
            heap_caps_malloc( sizeof( EventMonitor::Event ) * EventMonitor::MAX_EVENT_HISTORY, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT )
        );
        EventMonitor::Event * eventHistory1Buffer = static_cast< EventMonitor::Event * >(
            heap_caps_malloc( sizeof( EventMonitor::Event ) * EventMonitor::MAX_EVENT_HISTORY, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT )
        );
        EventMonitor::Event * eventHistory2Buffer = static_cast< EventMonitor::Event * >(
            heap_caps_malloc( sizeof( EventMonitor::Event ) * EventMonitor::MAX_EVENT_HISTORY, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT )
        );
        EventMonitor::Event * eventHistory3Buffer = static_cast< EventMonitor::Event * >(
            heap_caps_malloc( sizeof( EventMonitor::Event ) * EventMonitor::MAX_EVENT_HISTORY, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT )
        );
        ...
        void initialize()
        {
            ...
            if ( ! eventHistory0Buffer || ! eventHistory1Buffer ||
                 ! eventHistory2Buffer || ! eventHistory3Buffer )
            {
